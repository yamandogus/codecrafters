...
export default function JobsPage() {
  ...
  const categories = [
    { id: "all", name: "Tümü", icon: Briefcase, color: "bg-gray-100 dark:bg-gray-800" },
    { id: "frontend", name: "Frontend", icon: Briefcase, color: "bg-gray-100 dark:bg-gray-800" },
    { id: "backend", name: "Backend", icon: Briefcase, color: "bg-gray-100 dark:bg-gray-800" },
    { id: "fullstack", name: "Full Stack", icon: Briefcase, color: "bg-gray-100 dark:bg-gray-800" },
    { id: "mobile", name: "Mobil", icon: Briefcase, color: "bg-gray-100 dark:bg-gray-800" },
    { id: "devops", name: "DevOps", icon: Briefcase, color: "bg-gray-100 dark:bg-gray-800" },
    { id: "data", name: "Data Science", icon: Briefcase, color: "bg-gray-100 dark:bg-gray-800" }
  ];
