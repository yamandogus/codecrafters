...
export default function ProjectsPage() {
  ...
  const categories = [
    { id: "all", name: "Tümü", icon: Code, color: "bg-gray-100 dark:bg-gray-800" },
    { id: "web", name: "Web Uygulamaları", icon: Globe, color: "bg-gray-100 dark:bg-gray-800" },
    { id: "mobile", name: "Mobil Uygulamalar", icon: Smartphone, color: "bg-gray-100 dark:bg-gray-800" },
    { id: "backend", name: "Backend Sistemler", icon: Database, color: "bg-gray-100 dark:bg-gray-800" },
    { id: "ai", name: "AI/ML Projeleri", icon: Zap, color: "bg-gray-100 dark:bg-gray-800" },
    { id: "devops", name: "DevOps Araçları", icon: Cloud, color: "bg-gray-100 dark:bg-gray-800" }
  ];
