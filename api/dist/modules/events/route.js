...
router.post("/", authenticate, authorizeRoles("MODERATOR", "ADMIN"), (req, res) => controller.create(req, res));
router.put("/:id", authenticate, authorizeRoles("MODERATOR", "ADMIN"), // Sadece yetkililer güncelleyebilir
(req, res) => controller.update(req, res));
router.delete("/:id", authenticate, authorizeRoles("MODERATOR", "ADMIN"), (req, res) => controller.delete(req, res));
